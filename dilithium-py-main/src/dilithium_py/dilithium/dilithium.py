...
class Dilithium:
    ...
    @staticmethod
    def generate_local_rho():
        """Each party generates a local 32-byte random rho_i."""
        return os.urandom(32)

    @staticmethod
    def combine_rho(rho_list):
        """Combine all rho_i by XOR to get the global rho."""
        return reduce(lambda x, y: bytes(a ^ b for a, b in zip(x, y)), rho_list)


    def keygen(self, rho=None):
        """
        ...
        rho_prime, K = seed_bytes[32:96], seed_bytes[96:]
